 ...
 * They operate on an {@link io.github.agentic.spring.ai.graph.OverAllState} and can optionally
 * interact with a {@link io.github.agentic.spring.ai.graph.RunnableConfig}.
 *
 * <p>
 ...
 * <ul>
 * <li>{@link io.github.agentic.spring.ai.graph.action.NodeAction}: Represents a synchronous
 ...
 * <li>{@link io.github.agentic.spring.ai.graph.action.NodeActionWithConfig}: Similar to
 * {@code NodeAction}, but also accepts a
 * {@link io.github.agentic.spring.ai.graph.RunnableConfig} parameter, allowing for more
 * configurable node behavior at runtime.</li>
 * <li>{@link io.github.agentic.spring.ai.graph.action.EdgeAction}: Defines synchronous
 ...
 * <li>{@link io.github.agentic.spring.ai.graph.action.CommandAction}: Represents a synchronous
 * action that evaluates the agent state and a
 * {@link io.github.agentic.spring.ai.graph.RunnableConfig} to produce a
 * {@link io.github.agentic.spring.ai.graph.action.Command}. This command encapsulates both
 * potential state updates and the next node to transition to, offering a structured way
 * to define node outcomes.</li>
 * <li>{@link io.github.agentic.spring.ai.graph.action.AsyncNodeAction}: An asynchronous
 ...
 * <li>{@link io.github.agentic.spring.ai.graph.action.AsyncEdgeAction}: The asynchronous version
 ...
 *
 */
package io.github.agentic.spring.ai.graph.action;
