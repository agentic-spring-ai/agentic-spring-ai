...
import io.github.agentic.spring.ai.graph.checkpoint.savers.file.FileSystemSaver;
...
public class StateGraphSerializerTest {
	...
	public void testStateGraphSerializerWithFileSystemSaver() throws Exception {
		...
		CompileConfig config = CompileConfig.builder()
			.saverConfig(io.github.agentic.spring.ai.graph.checkpoint.config.SaverConfig.builder()
				.register(saver)
				.build())
			.build();
