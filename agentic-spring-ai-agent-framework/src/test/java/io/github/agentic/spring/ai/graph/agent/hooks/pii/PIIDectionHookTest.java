 ...
 */
package io.github.agentic.spring.ai.graph.agent.hooks.pii;
...
import io.github.agentic.spring.ai.graph.agent.hook.pii.PIIDetectors;
...
public class PIIDectionHookTest {
    ...
    public void testPIIDetectionWithBlockStrategy() throws Exception {
        ...
        try {
            ...
            if (e.getCause() instanceof io.github.agentic.spring.ai.graph.agent.hook.pii.PIIDetectionException) {
