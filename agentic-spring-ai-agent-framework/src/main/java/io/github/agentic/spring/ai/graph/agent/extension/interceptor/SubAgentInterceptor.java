...
import io.github.agentic.spring.ai.graph.agent.extension.tools.model.TaskTool;
...
public class SubAgentInterceptor extends ModelInterceptor {
	...
	private ReactAgent createGeneralPurposeAgent(
		...
		io.github.agentic.spring.ai.graph.agent.Builder builder = ReactAgent.builder()
