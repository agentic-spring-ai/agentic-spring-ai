...
const DifyConverter: React.FC = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const params = {
        dependencies: 'agentic-spring-ai-graph,web,agentic-spring-ai-starter-dashscope',
        appMode: 'workflow',
        dslDialectType: 'dify',
        type: 'maven-project',
        language: 'java',
      ...
      link.href = url;
      link.download = 'agentic-spring-ai-demo.zip';
      ...
      setConvertResult([
        ...
        $i18n.get({
          ...
          dm: '包含依赖: agentic-spring-ai-graph, web, agentic-spring-ai-starter-dashscope',
        }),
        $i18n.get({
