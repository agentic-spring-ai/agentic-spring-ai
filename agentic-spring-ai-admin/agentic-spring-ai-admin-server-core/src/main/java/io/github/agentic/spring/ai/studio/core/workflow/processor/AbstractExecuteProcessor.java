...
package io.github.agentic.spring.ai.studio.core.workflow.processor;

import io.github.agentic.spring.ai.studio.runtime.exception.BizException;
import io.github.agentic.spring.ai.studio.runtime.enums.ErrorCode;
import io.github.agentic.spring.ai.studio.runtime.domain.chat.ChatMessage;
import io.github.agentic.spring.ai.studio.runtime.domain.chat.MessageRole;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.CommonParam;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.Edge;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.Node;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.NodeResult;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.NodeStatusEnum;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.NodeTypeEnum;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.ValueFromEnum;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.inner.RetryConfig;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.inner.ShortTermMemory;
import io.github.agentic.spring.ai.studio.runtime.domain.workflow.inner.TryCatchConfig;
import io.github.agentic.spring.ai.studio.runtime.utils.JsonUtils;
import io.github.agentic.spring.ai.studio.core.config.CommonConfig;
import io.github.agentic.spring.ai.studio.core.base.manager.RedisManager;
import io.github.agentic.spring.ai.studio.core.workflow.WorkflowConfig;
import io.github.agentic.spring.ai.studio.core.workflow.WorkflowContext;
import io.github.agentic.spring.ai.studio.core.utils.LogUtils;
import io.github.agentic.spring.ai.studio.core.utils.common.VariableUtils;
import io.github.agentic.spring.ai.studio.core.workflow.WorkflowInnerService;
...
import static io.github.agentic.spring.ai.studio.core.base.constants.CacheConstants.APPCODE_CONVERSATION_ID_TEMPLATE;
import static io.github.agentic.spring.ai.studio.core.base.constants.CacheConstants.WORKFLOW_NODE_SELF_SHORT_MEMORY_TEMPLATE;
import static io.github.agentic.spring.ai.studio.core.base.constants.CacheConstants.WORKFLOW_SESSION_VARIABLE_KEY_TEMPLATE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.MEMORY_TYPE_CUSTOM;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.MEMORY_TYPE_SELF;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.NODE_BRANCH_DEFAULT;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.NODE_BRANCH_FAIL;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.NODE_CONFIG_RETRY;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.NODE_CONFIG_SHORT_MEMORY;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.NODE_CONFIG_TRY_CATCH;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.PARAM_TYPE_ARRAY_OBJECT_LOWER_CASE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.PARAM_TYPE_BOOLEAN_LOWER_CASE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.PARAM_TYPE_NUMBER_LOWER_CASE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.PARAM_TYPE_OBJECT_LOWER_CASE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.PARAM_TYPE_STRING_LOWER_CASE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.SYS_QUERY_KEY;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.TRY_CATCH_STRATEGY_DEFAULT_VALUE;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.TRY_CATCH_STRATEGY_FAIL_BRANCH;
import static io.github.agentic.spring.ai.studio.core.workflow.constants.WorkflowConstants.TRY_CATCH_STRATEGY_NOOP;
