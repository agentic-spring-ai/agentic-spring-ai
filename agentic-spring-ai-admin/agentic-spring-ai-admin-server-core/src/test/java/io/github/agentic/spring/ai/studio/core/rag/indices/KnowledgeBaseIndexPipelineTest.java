...
class KnowledgeBaseIndexPipelineTest {
	...
	void testParse() {
		...
		// Execute
		io.github.agentic.spring.ai.studio.runtime.domain.knowledgebase.Document document = io.github.agentic.spring.ai.studio.runtime.domain.knowledgebase.Document
			.builder()
			.docId("test-doc1")
			.kbId("test-kb1")
