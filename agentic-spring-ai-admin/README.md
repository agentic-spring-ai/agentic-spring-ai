...
>
> Spring AI Alibaba Website Repo: https://github.com/springaialibaba/agentic-spring-ai-website
...
```bash
git clone https://github.com/agentic-spring-ai/agentic-spring-ai-admin.git
cd agentic-spring-ai-admin
```

#### 2. Configure Your API Keys
Modify the model configuration in `agentic-spring-ai-admin-server-start/model-config.yaml` according to your model provider.
...
If you need to modify the Nacos address, please update the configuration in the `agentic-spring-ai-admin-server-start/src/main/resources/application.yml` file
```yaml
nacos:
...
Navigate to the `agentic-spring-ai-admin-server-start` directory and start the application:
```bash
mvn spring-boot:run
```
...
<dependencies>
    ...
    <dependency>
        ...
        <artifactId>agentic-spring-ai-agent-nacos</artifactId>
    ...
    <dependency>
        <groupId>io.github.agentic.spring.ai</groupId>
        <artifactId>agentic-spring-ai-autoconfigure-arms-observation</artifactId>
        <version>{spring.ai.alibaba.version}</version>
    </dependency>
