...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.ToolNodeData;
...
public class ToolNodeSection implements NodeSection<ToolNodeData> {
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.ToolNode", "java.util.function.Function",
