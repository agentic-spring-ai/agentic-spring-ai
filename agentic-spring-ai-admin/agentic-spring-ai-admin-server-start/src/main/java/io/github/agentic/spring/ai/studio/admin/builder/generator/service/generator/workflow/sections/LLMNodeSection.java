...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.LLMNodeData;
...
public class LLMNodeSection implements NodeSection<LLMNodeData> {
	...
	public List<String> getImports() {
		return List.of("org.springframework.ai.chat.messages.Message",
				...
				"io.github.agentic.spring.ai.dashscope.chat.DashScopeChatOptions",
