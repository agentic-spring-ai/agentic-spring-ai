 ...
 */
package io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.workflow.sections;
...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.CodeNodeData;
import io.github.agentic.spring.ai.studio.admin.builder.generator.service.dsl.DSLDialectType;
import io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.workflow.NodeSection;

import io.github.agentic.spring.ai.studio.admin.builder.generator.utils.ObjectToCodeUtil;
...
public class CodeNodeSection implements NodeSection<CodeNodeData> {
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.code.CodeExecutorNodeAction",
				"io.github.agentic.spring.ai.graph.node.code.entity.CodeExecutionConfig",
				"io.github.agentic.spring.ai.graph.node.code.CodeExecutor",
				"io.github.agentic.spring.ai.graph.node.code.LocalCommandlineCodeExecutor", "java.io.IOException",
				"java.nio.file.Files", "java.nio.file.Path", "java.util.stream.Collectors",
				"io.github.agentic.spring.ai.graph.node.code.entity.CodeParam",
				"io.github.agentic.spring.ai.graph.node.code.entity.CodeStyle");
	}
