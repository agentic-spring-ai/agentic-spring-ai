 ...
 */
package io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.agent.impl;

import io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.agent.AbstractAgentTypeProvider;
import io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.agent.AgentShell;
import io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.agent.CodeSections;
import io.github.agentic.spring.ai.studio.admin.builder.generator.service.generator.agent.RenderContext;
import org.springframework.stereotype.Component;

import java.util.List;
import java.util.Map;

import static io.github.agentic.spring.ai.studio.admin.builder.generator.utils.CodeGenUtils.*;
...
public class ReactAgentProvider extends AbstractAgentTypeProvider {
	...
	public CodeSections render(AgentShell shell, Map<String, Object> handle, RenderContext ctx,
		...
		return new CodeSections().imports("import io.github.agentic.spring.ai.graph.CompiledGraph;",
				"import io.github.agentic.spring.ai.graph.agent.ReactAgent;", "import io.github.agentic.spring.ai.graph.KeyStrategy;",
