...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.VariableAggregatorNodeData;
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.VariableAggregatorNodeData.Groups;
...
public class VariableAggregatorNodeSection implements NodeSection<VariableAggregatorNodeData> {
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.VariableAggregatorNode", "java.util.stream.Collectors");
	}
