...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.DocumentExtractorNodeData;
...
public class DocumentExtractorNodeSection implements NodeSection<DocumentExtractorNodeData> {
	...
	public String render(Node node, String varName) {
		...
		List<io.github.agentic.spring.ai.studio.admin.builder.generator.model.VariableSelector> inputs = data.getInputs();
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.DocumentExtractorNode");
	}
