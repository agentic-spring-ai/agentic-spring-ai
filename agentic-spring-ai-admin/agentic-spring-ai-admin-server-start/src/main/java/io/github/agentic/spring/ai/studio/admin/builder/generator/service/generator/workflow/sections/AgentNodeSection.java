...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.AgentNodeData;
...
public class AgentNodeSection implements NodeSection<AgentNodeData> {
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.AgentNode", "org.springframework.ai.tool.ToolCallback");
	}
