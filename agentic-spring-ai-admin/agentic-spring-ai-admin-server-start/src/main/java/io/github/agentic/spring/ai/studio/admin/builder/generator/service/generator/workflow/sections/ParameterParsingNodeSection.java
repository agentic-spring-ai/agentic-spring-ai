...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.ParameterParsingNodeData;
...
public class ParameterParsingNodeSection implements NodeSection<ParameterParsingNodeData> {
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.ParameterParsingNode",
