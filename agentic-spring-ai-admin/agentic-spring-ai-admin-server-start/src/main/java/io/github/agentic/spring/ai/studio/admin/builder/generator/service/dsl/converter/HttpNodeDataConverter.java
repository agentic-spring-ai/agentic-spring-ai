...
import io.github.agentic.spring.ai.graph.node.HttpNode.AuthConfig;
import io.github.agentic.spring.ai.graph.node.HttpNode.HttpRequestNodeBody;
import io.github.agentic.spring.ai.graph.node.HttpNode.RetryConfig;
import io.github.agentic.spring.ai.graph.node.HttpNode.TimeoutConfig;
...
import io.github.agentic.spring.ai.studio.admin.builder.generator.model.workflow.nodedata.HttpNodeData;
	...
	private enum HttpNodeDialectConverter {
		...
		DIFY(new DialectConverter<>() {
			...
			public HttpNodeData parse(Map<String, Object> data) throws JsonProcessingException {
				...
				List<io.github.agentic.spring.ai.studio.admin.builder.generator.model.Variable> outputs = List.of();
