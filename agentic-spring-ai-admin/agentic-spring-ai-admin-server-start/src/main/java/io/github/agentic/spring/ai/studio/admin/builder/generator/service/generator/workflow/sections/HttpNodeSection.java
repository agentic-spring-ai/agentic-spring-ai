...
import io.github.agentic.spring.ai.graph.node.HttpNode;
...
public class HttpNodeSection implements NodeSection<HttpNodeData> {
	...
	public List<String> getImports() {
		return List.of("io.github.agentic.spring.ai.graph.node.HttpNode", "org.springframework.http.HttpMethod");
	}
