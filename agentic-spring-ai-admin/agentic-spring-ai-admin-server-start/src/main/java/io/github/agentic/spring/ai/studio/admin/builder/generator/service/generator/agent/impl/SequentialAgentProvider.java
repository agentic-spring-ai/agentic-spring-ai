...
public class SequentialAgentProvider extends AbstractAgentTypeProvider {
	...
	public CodeSections render(AgentShell shell, Map<String, Object> handle, RenderContext ctx,
		...
		return new CodeSections()
			.imports("import io.github.agentic.spring.ai.graph.agent.flow.agent.SequentialAgent;",
					...
					"import io.github.agentic.spring.ai.graph.state.strategy.ReplaceStrategy;", "import java.util.*;")
			.code(code.toString())
			.var(var);
	}
