 ...
 */
package io.github.agentic.spring.ai.examples.multiagents.skills;
 ...
 * into the system prompt via {@link io.github.agentic.spring.ai.graph.agent.interceptor.skills.SkillsInterceptor}.
 */
@Configuration
