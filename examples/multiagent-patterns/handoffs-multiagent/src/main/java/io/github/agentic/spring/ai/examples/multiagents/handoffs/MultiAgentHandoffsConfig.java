 ...
 */
package io.github.agentic.spring.ai.examples.multiagents.handoffs;

import io.github.agentic.spring.ai.examples.multiagents.handoffs.route.RouteAfterSalesAction;
import io.github.agentic.spring.ai.examples.multiagents.handoffs.route.RouteAfterSupportAction;
import io.github.agentic.spring.ai.examples.multiagents.handoffs.route.RouteInitialAction;
import io.github.agentic.spring.ai.examples.multiagents.handoffs.state.MultiAgentStateConstants;
import io.github.agentic.spring.ai.examples.multiagents.handoffs.tools.TransferToSalesTool;
import io.github.agentic.spring.ai.examples.multiagents.handoffs.tools.TransferToSupportTool;
...
public class MultiAgentHandoffsConfig {
	...
	public CompiledGraph multiAgentHandoffsGraph(ReactAgent multiAgentSalesAgent,
		...
		StateGraph graph = new StateGraph("multi_agent_handoffs", () -> {
			Map<String, io.github.agentic.spring.ai.graph.KeyStrategy> strategies = new HashMap<>();
