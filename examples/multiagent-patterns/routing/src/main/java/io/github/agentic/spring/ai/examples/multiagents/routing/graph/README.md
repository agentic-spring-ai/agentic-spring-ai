...
- [Subgraph as CompiledGraph](../../documentation/src/main/java/io/github/agentic/spring/ai/examples/documentation/graph/examples/SubgraphAsCompiledGraphExample.java) – agent as graph node.
