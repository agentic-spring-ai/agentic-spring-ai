...
package io.github.agentic.spring.ai.examples.documentation.framework.advanced.a2a;
...
public class A2AAgentConfig {
	...
	public AgentLoader agentLoader(@Qualifier("dataAnalysisAgent") ReactAgent dataAnalysisAgent) {
		return new AgentLoader() {
			...
			@Override
			public io.github.agentic.spring.ai.graph.agent.Agent loadAgent(String name) {
