...
package io.github.agentic.spring.ai.examples.documentation.framework.tutorials.mcp;
...
@SpringBootApplication(exclude = {  //移除一些无须使用的不相关配置加载
        io.github.agentic.spring.ai.agent.studio.SaaStudioWebModuleAutoConfiguration.class,
