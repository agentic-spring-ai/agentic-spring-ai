 ...
 */
package io.github.agentic.spring.ai.agent.studio.config;
...
class StudioConfigurationMetadataCompatibilityTest {

	private static final String PRODUCTION_METADATA = "/META-INF/additional-spring-configuration-metadata.json";

	private static final String CONTRACT_METADATA = "/compatibility/2.1.0/studio-metadata.json";

	private final ObjectMapper mapper = new ObjectMapper();

	@Test
	void metadataKeepsExecutionAuthPropertyNameTypeAndDefaultCompatible() throws IOException {
