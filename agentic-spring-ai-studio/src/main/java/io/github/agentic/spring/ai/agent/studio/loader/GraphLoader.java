 ...
 * and exposes them by their graph name (from {@link io.github.agentic.spring.ai.graph.StateGraph#getName()}
 * or bean name). You can therefore use Studio without implementing this interface: just define your
 * graphs as {@code @Bean}s (e.g. from {@link io.github.agentic.spring.ai.graph.StateGraph#compile()})
