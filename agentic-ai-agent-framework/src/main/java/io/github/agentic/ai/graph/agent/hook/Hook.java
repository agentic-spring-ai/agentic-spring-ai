...
import io.github.agentic.spring.ai.graph.agent.Prioritized;
...
import static io.github.agentic.spring.ai.graph.RunnableConfig.AGENT_HOOK_NAME_PREFIX;
...
public interface Hook extends Prioritized {
	 ...
	 * <ul>
	 *   <li>{@link io.github.agentic.spring.ai.graph.state.strategy.AppendStrategy}: Append to existing values</li>
	 *   <li>{@link io.github.agentic.spring.ai.graph.state.strategy.ReplaceStrategy}: Replace existing values</li>
	 * </ul>
	 *
